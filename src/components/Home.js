      ...
      <>
        <div className="hero position-relative overflow-hidden p-3 p-md-5 text-center bg-light">
          <div className="hero-text col-md-5 p-lg-5 mx-auto my-5">
            <h1 className="display-4 fw-normal">For you the real-estate enthusiast</h1>
            <p className="lead fw-normal">Do you need a home design idea? We got you covered. Browse through rhe list and find your dream houses you want to own in the near future.</p>
            <a className="btn hero__explore-btn" href="#houses">Explore</a>
          </div>
        </div>

        <div className="container-fluid">
          <div id="houses" className="houses-container py-2 py-md-4 row g-3">
            {houses.length
              && (houses.map(house => (
